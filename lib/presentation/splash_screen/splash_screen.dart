...
// if (videouid.isNotEmpty) {
  ...
  SetUi() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setString(PreferencesKey.appApkMinVersion, "14");
    prefs.setString(PreferencesKey.appApkLatestVersion, "1");
    prefs.setString(PreferencesKey.appApkRouteVersion, "13");

    prefs.setString(PreferencesKey.IPAIosMainversion, "14");
    prefs.setString(PreferencesKey.IPAIosLatestVersion, "1");
    prefs.setString(PreferencesKey.IPAIosRoutVersion, "13");
