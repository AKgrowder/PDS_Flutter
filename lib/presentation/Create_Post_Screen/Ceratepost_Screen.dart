...
/*   void _onTextChanged() {
  ...
  void initState() {
    ...
    print("image data show from data${widget.edittextdata}");
                        ...
                        child: UserProfileImage?.isEmpty == true
                            ...
                            : SizedBox(
                                ...
                                child: CircleAvatar(
                                  backgroundColor: Colors.white,
                                  backgroundImage:
                                      NetworkImage(UserProfileImage.toString()),
                                ),
                              ),
                      ),
                    ),
                ...
                child: Column(
                  children: [
                    ...
                    if (widget.edittextdata != null)
                      Column(
                        children: [
                          widget.postDataType == 'VIDEO'
                              ? Padding(
                                  padding: const EdgeInsets.all(20),
                                  child: VideoListItem(
                                      videoUrl: widget.mutliplePost?[0]),
                                )
                              : Container(
                                  width: _width,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child:
                                          widget.postDataTypeRepost == 'VIDEO'
                                              ? Padding(
                                                  padding:
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child: PageView
                                                                          ...
                                                                          itemBuilder:
                                                                            ...
                                                                            } else if (widget.postDataTypeRepost ==
                                                                                "ATTACHMENT") {
                                                                              return Container(
                                                                                  height: 400,
                                                                                  width: _width,
                      ...
                      children: [
                        ...
                        imageDataPost?.object?.data != null &&
                            ...
                            ? Container(
                                ...
                                child: DotsIndicator(
                                  dotsCount:
                                      imageDataPost?.object?.data?.length ?? 0,
