...
class DeleteComapnyDailog extends StatefulWidget {
  String postUid;
  DeleteComapnyDailog({Key? key, required this.postUid}) : super(key: key);
      ...
      child: Material(
        ...
        child: ScaleTransition(
          ...
          child: Container(
            ...
            child: BlocConsumer<ComapnyManageCubit, ComapnyManageState>(
              listener: (context, state) {
                if (state is CompnayDeletPageState) {
                  showDialog(
                    context: context,
