...
class NewNotifactionScreen extends StatefulWidget {
   bool? isScreen;
    NewNotifactionScreen({Key? key,this.isScreen}) : super(key: key);
                                          ...
                                          : AllNotificationData?.object?[index]
                                            ...
                                            : AllNotificationData?.object?[index].subject == "EXPERT_LEFT_ROOM" ||
                                                ...
                                                : AllNotificationData?.object?[index].subject ==
                                                    ...
                                                    : */
                                                  : AllNotificationData?.object?[index].subject == "LIKE_POST" || AllNotificationData?.object?[index].subject == "COMMENT_POST" || AllNotificationData?.object?[index].subject == "TAG_COMMENT_POST"
                                                      ? Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                              builder: (context) =>
                                                      ...
                                                      : AllNotificationData?.object?[index].subject == "FOLLOW_PUBLIC_ACCOUNT" || AllNotificationData?.object?[index].subject == "FOLLOW_PRIVATE_ACCOUNT_REQUEST" || AllNotificationData?.object?[index].subject == "FOLLOW_REQUEST_ACCEPTED" || AllNotificationData?.object?[index].subject == "PROFILE_APPROVED" || AllNotificationData?.object?[index].subject == "PROFILE_REJECTED" || AllNotificationData?.object?[index].subject == "PROFILE_VIEWED"
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: AllNotificationData
                                                      ...
                                                      ? CustomImageView(
                                                          url:
                                                              "${AllNotificationData?.object?[index].image}",
                                                          height: 60,
                                                          width: 60,
                                                          fit: BoxFit.fill,
                                                          radius: BorderRadius
                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          if (widget.requestListModelData?.object?[index]
                                  .createdAt !=
                              null) {
