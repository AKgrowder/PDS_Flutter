...
class _HomeScreenNewState extends State<HomeScreenNew>
  ...
  /*void listener(YoutubeController controller) {
                    ...
                    GestureDetector(
                      onTap: () {
                        final Uri url = Uri.parse(Platform.isIOS == true
                            ...
                            : "https://play.google.com/store/apps/details?id=com.ip.app");
                                                                    ...
                                                                    onTap: () {
                                                                      if (AllGuestPostRoomData
                                                                        ...
                                                                        Navigator.push(
                                                                            context,
                                                                            MaterialPageRoute(
                                                                              builder: (context) => OpenSavePostImage(PostID: AllGuestPostRoomData?.object?.content?[index].postUid),
                                                                            )).then((value) {
                                                                          setColorr();
                                                                          setState(
                                                                              () {});
                                                                          ...
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              leading: GestureDetector(
                                                                                ...
                                                                                child: AllGuestPostRoomData?.object?.content?[index].userProfilePic != null && AllGuestPostRoomData?.object?.content?[index].userProfilePic != ""
                                                                                    ? CircleAvatar(
                                                                              ...
                                                                              trailing: User_ID == AllGuestPostRoomData?.object?.content?[index].userUid
                                                                                  ? GestureDetector(
                                                                                      key: buttonKey,
                                                                                      onTap: () {
                                                            ...
                                                            onTap: () {
                                                              Navigator.pop(
                                                                    context);
                                                                          ...
                                                                          AllGuestPostRoomData?.object?.content?[index].description != null
                                                                              ? Padding(
                                                                                  padding: const EdgeInsets.only(left: 16),
                                                                                  child: GestureDetector(
                                                                                      onTap: () async {
                                                                                        if (isYouTubeUrl(extractUrls(AllGuestPostRoomData?.object?.content?[index].description ?? "").first)) {
                                                                                          playLink(extractUrls(AllGuestPostRoomData?.object?.content?[index].description ?? "").first, context);
                                                                                        } else if (DataGet == true) {
                                                                                                  ...
                                                                                                  child: Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      ...
                                                                                                      if (extractUrls(AllGuestPostRoomData?.object?.content?[index].description ?? "").isNotEmpty)
                                                                                                        isYouTubeUrl(extractUrls(AllGuestPostRoomData?.object?.content?[index].description ?? "").first)
                                                                                                            ? FutureBuilder(
                                                                                                            ...
                                                                                                            : Padding(
                                                                                                                ...
                                                                                                                child: AnyLinkPreview(
                                                                                                                  ...
                                                                                                                  onTap: () {
                                                                                                                    launchUrl(Uri.parse(extractUrls(AllGuestPostRoomData?.object?.content?[index].description ?? "").first));
                                                                          ...
                                                                          (AllGuestPostRoomData?.object?.content?[index].postData?.isEmpty ?? false)
                                                                              ? SizedBox()
                                                                              : Container(
                                                                                  // height: 200,
                                                                                  width: _width,
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    AllGuestPostRoomData?.object?.content?[index].repostOn?.description != null
                                                                                        ? Padding(
                                                                                            ...
                                                                                            child: Column(
                                                                                              children: [
                                                                                                ...
                                                                                                if (extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").isNotEmpty)
                                                                                                  isYouTubeUrl(extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").first)
                                                                                                      ? FutureBuilder(
                                                                                                          future: fetchYoutubeThumbnail(extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").first),
                                                                                                          builder: (context, snap) {
                                                                                                            return Container(
                                                                                                              height: 250,
                                                                                                              decoration: BoxDecoration(image: DecorationImage(image: CachedNetworkImageProvider(snap.data.toString())), borderRadius: BorderRadius.circular(10)),
                                                                                                              ...
                                                                                                              child: Center(
                                                                                                                ...
                                                                                                                onPressed: () {
                                                                                                                  playLink(extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").first, context);
                                                                                                                },
                                                                                                              )),
                                                                                                            );
                                                                                                          })
                                                                                                      : Padding(
                                                                                                          padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 8.0),
                                                                                                          child: AnyLinkPreview(
                                                                                                            link: extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").first,
                                                                                                            displayDirection: UIDirection.uiDirectionHorizontal,
                                                                                                            showMultimedia: true,
                                                                                                            bodyMaxLines: 5,
                                                                                                            bodyTextOverflow: TextOverflow.ellipsis,
                                                                                                            ...
                                                                                                            onTap: () {
                                                                                                              launchUrl(Uri.parse(extractUrls(AllGuestPostRoomData?.object?.content?[index].repostOn?.description ?? "").first));
                                                                                                            }, // This disables tap event
                                                                                                          ),
                                                                                                        ),
                                                                                              ],
                                                                                        ...
                                                                                        : SizedBox(),
                                                                                    if (AllGuestPostRoomData?.object?.content?[index].repostOn?.translatedDescription != null && readmoree[index] == true)
                                                                                      GestureDetector(
                                                                                        onTap: () {
                                                                            ...
                                                                            if (uuid ==
                                                                              ...
                                                                              if (AllGuestPostRoomData?.object?.content?[index].postDataType != "VIDEO") {
                                                                                ...
                                                                                if (AllGuestPostRoomData!.object!.content![index].thumbnailImageUrl != null) {
                                                                                  ...
                                                                                  if (AllGuestPostRoomData!.object!.content![index].postData != null && AllGuestPostRoomData!.object!.content![index].postData!.isNotEmpty) {
                                                                                    ...
                                                                                    if (AllGuestPostRoomData!.object!.content![index].repostOn != null && AllGuestPostRoomData!.object!.content![index].repostOn!.thumbnailImageUrl != null) {
                                                                                      ...
                                                                                      thumb = AllGuestPostRoomData!.object!.content![index].repostOn != null && AllGuestPostRoomData!.object!.content![index].repostOn!.postData != null && AllGuestPostRoomData!.object!.content![index].repostOn!.postData!.isNotEmpty ? AllGuestPostRoomData!.object!.content![index].repostOn!.postData!.first : "";
                                                                                    }
                                                                                  }
                                                                                }
                                                                                ...
                                                                                final fileName = await VideoThumbnail.thumbnailFile(
                                                                                  video: AllGuestPostRoomData?.object?.content?[index].postData?.first ?? "",
                                                                ...
                                                                if (AllGuestPostRoomData
                                                                  ...
                                                                  Navigator.push(
                                                                      ...
                                                                      MaterialPageRoute(
                                                                        builder:
                                                                            (context) =>
                                                                                OpenSavePostImage(PostID: AllGuestPostRoomData?.object?.content?[index].postUid),
                                                                      )).then((value) {
                                                                    setColorr();
                                                                    setState(
                                                                        () {});
                                                              ...
                                                              onTap: () {
                                                                Navigator.pop(
                                                                    ...
                                                                    Container(
                                                                      width:
                                                                          _width,
                                                                      child: AllGuestPostRoomData?.object?.content?[index].postDataType ==
                                                                              null
                                                                          ? SizedBox()
                                                                          : AllGuestPostRoomData?.object?.content?[index].postData?.length == 1
                                                                              ? (AllGuestPostRoomData?.object?.content?[index].postDataType == "IMAGE"
                                                                      ...
                                                                      if (uuid ==
                                                                        ...
                                                                        if (AllGuestPostRoomData?.object?.content?[index].postDataType !=
                                                                          ...
                                                                          String
                                                                              thumb =
                                                                              "";
                                                                          if (AllGuestPostRoomData!.object!.content![index].thumbnailImageUrl !=
                                                                              null) {
                                                                            thumb =
                                                                                AllGuestPostRoomData!.object!.content![index].thumbnailImageUrl!;
                                                                          } else {
                                                                            if (AllGuestPostRoomData!.object!.content![index].postData != null &&
                                                                          ...
                                                                          final fileName =
                                                                            ...
                                                                            video:
                                                                                AllGuestPostRoomData?.object?.content?[index].postData?.first ?? "",
                                                                            thumbnailPath:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            ...
                                                                            Text("${getallBlogModel1?.object?[index1].commentCount == null ? 0 : getallBlogModel1?.object?[index1].commentCount}"),
