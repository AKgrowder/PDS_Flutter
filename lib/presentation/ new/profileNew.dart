                                                                ...
                                                                Container(
                                                                  ...
                                                                  margin: EdgeInsets
                                                                      .only(
                                                                          ...
                                                                          top:
                                                                              10),
                                                                  child: GetUserPostCommetData?.object?[index].userProfilePic !=
                                                                              null &&
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: Column(
                                                                          ...
                                                                          DateTime
                                                                              parsedDateTime2 =
                                                                              DateTime.parse('${GetUserPostCommetData?.object?[index].comments?[index2].createdAt}');
                                                                          return Row(
                                                                            crossAxisAlignment:
                                                                                CrossAxisAlignment.start,
                                                                            children: [
  ...
  Widget creratePostUser(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        DateTime parsedDateTime =
            DateTime.parse('${getAllPostData?.object?[index].createdAt ?? ""}');
        DateTime? repostTime;
