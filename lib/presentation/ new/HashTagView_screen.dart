...
class _HashTagViewScreenState extends State<HashTagViewScreen> with Observer {
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: hashTagViewData
                                                                    ...
                                                                    : hashTagViewData?.object?.posts?[index].isFollowing ==
                                                                            'REQUESTED'
                                                                        ? Text(
                                                                            'Requested',
                                                                            style: TextStyle(
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        if (extractUrls(hashTagViewData
                                                                    ?.object
                                                                    ?.posts?[
                                                                        index]
                                                                    .description ??
                                                                "")
                                                            .isNotEmpty)
                                                          isYouTubeUrl(extractUrls(hashTagViewData
                                                                          ?.object
                                                                          ?.posts?[
                                                                              index]
                                                                          .description ??
                                                              ...
                                                              ? FutureBuilder(
                                                                  future: fetchYoutubeThumbnail(
                                                                      extractUrls(hashTagViewData?.object?.posts?[index].description ??
                                                                              "")
                                                                          .first),
                                                                  builder:
                                                                      (context,
                                                                    ...
                                                                    return Container(
                                                                      ...
                                                                      child: Center(
                                                                        ...
                                                                        onPressed:
                                                                            () {
                                                                          playLink(
                                                                              extractUrls(hashTagViewData?.object?.posts?[index].description ?? "").first,
                                                                              context);
                                                                        },
                                                                      )),
                                                                    );
                                                              ...
                                                              : Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap: () {
                                                                      launchUrl(Uri.parse(extractUrls(hashTagViewData?.object?.posts?[index].description ??
                                                                              "")
                                                                          .first));
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        GestureDetector(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                CachedNetworkImage(
                                                                              imageUrl: hashTagViewData?.object?.posts?[index].thumbnailImageUrl ?? "",
                                                                              fit: BoxFit.cover,
                                                                            ),
                                                                          ),
                                                                        )
                                                                    ...
                                                                    child: PageView
                                                                      ...
                                                                      itemBuilder:
                                                                          (BuildContext context,
                                                                              int index1) {
                                                                        if (hashTagViewData?.object?.posts?[index].postDataType ==
                                                                            "IMAGE") {
                                                                        ...
                                                                        } else if (hashTagViewData?.object?.posts?[index].postDataType ==
                                                                            "ATTACHMENT") {
                                                                          return Container(
                                                                              // height: 100,
                                                                              width: _width,
                                                                              child: DocumentViewScreen1(
                                                                                path: hashTagViewData?.object?.posts?[index].postData?[index1].toString(),
                                                                              ));
                                                                        }
                                                                      },
                                                                    ),
                                                                    ...
                                                                    ? Positioned(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                DotsIndicator(
                                                                              dotsCount: hashTagViewData?.object?.posts?[index].postData?.length ?? 0,
  ...
  void _settingModalBottomSheet1(context, index, _heigth) {
    ...
    showBottomSheet(
        ...
        showDragHandle: true, */
        enableDrag: true,
        constraints: BoxConstraints(maxHeight: _heigth / 1.5),
        context: context,
