...
class EditHomeDilogScreen extends StatefulWidget {
  String? uid;
  String? parentName;
  EditHomeDilogScreen({this.uid, this.parentName});
  @override
  State<StatefulWidget> createState() => EditHomeDilogScreenState();
}

class EditHomeDilogScreenState extends State<EditHomeDilogScreen>
              ...
              listener: (context, state) {
                ...
                if (state is EditroomLoadedState) {
                  ...
                  SnackBar snackBar = SnackBar(
                    content: Text(
                        /* state.editRoom.message ?? */ "Your Forum Updated SuccessFully!"),
