                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  PublicRoomModelData?.object?[index].message
                                              ?.message !=
                                          null
                                      ? Row(
                                          crossAxisAlignment:
                ...
                child: Column(
                  children: [
                    ...
                    User_ID != null
                        ...
                        : SizedBox(),
                    MyPublicRoomData?.object?.length != 0
                        ? User_Module == "COMPANY" || User_Module == "EMPLOYEE"
                            ? ListView.builder(
                                itemCount:
                                    (MyPublicRoomData?.object?.length ?? 0) > 5
                                        ? 5
                    ...
                    ListView.builder(
                      itemCount:
                          (FetchPublicRoomModelData?.object?.length ?? 0) > 5
                              ? 5
                              : FetchPublicRoomModelData?.object?.length,
                      shrinkWrap: true,
                      physics: NeverScrollableScrollPhysics(),
                      itemBuilder: (context, index) {
                        return Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FetchPublicRoomModelData?.object?[index]
                                              .message?.message !=
                                          null
                                      ? Row(
                                          crossAxisAlignment:
