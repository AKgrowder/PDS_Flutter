...
class UnBlockUserdailog extends StatefulWidget {
  String? blockUserID;
  String? userName;
  UnBlockUserdailog({Key? key, this.blockUserID, this.userName})
      : super(key: key);
  @override
  State<StatefulWidget> createState() => UnBlockUserdailogState();
}

class UnBlockUserdailogState extends State<UnBlockUserdailog>
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text("Unblock ${widget.userName}?",
                                      style: TextStyle(
                                        fontFamily: 'outfit',
                                        fontSize: 20,
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: [
                                Text(
                                    "Are you sure you want to unblock the ${widget.userName}?",
                                    textScaleFactor: 1.0,
