...
class StoryItem {
  ...
  factory StoryItem.pageImage({
    ...
    return StoryItem(
      ...
      shown: shown,
      duration: duration ?? Duration(seconds: 3),index: index
    );
  }
  ...
  factory StoryItem.pageVideo(String url, {
    ...
    return StoryItem(
        ...
        shown: shown,
        duration: duration ?? Duration(seconds: 10),index:index);
  }
...
class StoryViewState extends State<StoryView> with TickerProviderStateMixin {
          ...
          if (widget.userId! !=
            ...
            Positioned(
                ...
                child: Material(
                  ...
                  child: Container(
                    height: 50,
                    margin: EdgeInsets.only(left: 15, right: 15,bottom: MediaQuery.of(context).viewInsets.bottom),
                        ...
                        TextButton(
                          onPressed: () {
                            Repository().reactionMessageAddedOnStory(
                                context,
                                reactionData.text,
                                widget.buttonData!.images[_currentStory!.index!]
                                    .storyUid
                                    .toString());
  ...
  void handleEmojiSelection(String emoji, BuildContext context) {
    ...
    Repository().reactionMessageAddedOnStory(context, emoji,
        widget.buttonData!.images[_currentStory!.index!].storyUid.toString(),
        emojiReaction: true);

    if (widget.userId != widget.buttonData!.images[_currentStory!.index!].userUid) {
      widget.controller.play();
