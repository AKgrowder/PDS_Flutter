...
import 'package:stories_editor/res/data.dart';
...
class DraggableWidget extends StatelessWidget {
          ...
          child: IntrinsicHeight(
            child: Container(
              ...
              child: AnimatedOnTapButton(
                onTap: () => emojis.contains(draggableWidget.text)?null:_onTap(context, draggableWidget, _controlProvider),
                child: Stack(
  ...
  void _onTap(BuildContext context, EditableItem item,
    ...
    controlNotifier.isTextEditing = emojis.contains(item.text)? false : !controlNotifier.isTextEditing;
  }
}
